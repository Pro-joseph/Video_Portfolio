...
<div class="pf-page">
    ...
    <div class="pf-filters" id="filterBar">
        ...
        <button class="filter-pill capitalize" data-category="{{ $cat->slug }}">{{ $cat->name }}</button>
        @endforeach
    </div>
    @endif
    ...
    <div class="pf-count" id="projectCount">
        Showing <span id="visibleCount">{{ $projects->count() }}</span> of {{ $projects->count() }} projects
    </div>
    ...
    <div class="pf-grid" id="projectsGrid">
        ...
        >
            <div class="pf-card-media">
                <img
                    src="{{ $project->cover_image ? (str_starts_with($project->cover_image, 'http') ? $project->cover_image : asset($project->cover_image)) : 'https://images.unsplash.com/photo-1574717024653-61fd2cf4d44d?w=800&q=80' }}"
                    alt="{{ $project->title }}"
                    loading="lazy"
                >
            ...
            <div class="pf-card-info">
                <div>
                    <p class="pf-card-cat">{{ $project->category?->name ?? 'Project' }}</p>
                    <h2 class="pf-card-title">{{ $project->title }}</h2>
                </div>
