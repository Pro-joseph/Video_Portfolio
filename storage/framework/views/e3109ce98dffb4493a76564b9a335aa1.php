                ...
                <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('password.request')): ?>
                            <a class="text-sm text-gray-600 hover:text-secondary transition-colors" href="<?php echo e(route('password.request')); ?>">
                                Forgot password?
                            </a>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    ...
                    <p class="text-center text-sm text-gray-600">
                        Don't have an account? <a href="<?php echo e(route('register')); ?>" class="text-secondary hover:underline">Register</a>
                    </p>
                </form>
            </div>
        </div>
    </body>
</html><?php /**PATH C:\Users\jdira\Herd\video_portfolio\resources\views\auth\login.blade.php ENDPATH**/ ?>