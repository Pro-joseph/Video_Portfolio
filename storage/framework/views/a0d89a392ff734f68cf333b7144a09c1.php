...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title>Reset Password - FrameFlow</title>
            ...
            <div class="w-full sm:max-w-md mt-6 px-8 py-8 bg-white">
                <form method="POST" action="<?php echo e(route('password.store')); ?>" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input id="email" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary focus:border-transparent outline-none" type="email" name="email" value="<?php echo e(old('email', $request->email)); ?>" required autofocus autocomplete="username" />
...
</html><?php /**PATH C:\Users\jdira\Herd\video_portfolio\resources\views\auth\reset-password.blade.php ENDPATH**/ ?>